...
`scripts/fetch_trend_animal_snapshot.py` 为研究工作站补充 13 个重点商品的趋势快照：燃油、苯乙烯、碳酸锂、豆粕、鸡蛋、焦煤、铁矿石、沪金、沪银、欧线集运、生猪、棕榈油、天然橡胶；同时按需定位上证 50、沪深 300、中证 500、中证 1000、科创 50、创业板 50 指数。它不会替代奇货可查席位数据，也不会自动生成交易指令。
