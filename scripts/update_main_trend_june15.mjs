...
const inputPath = "C:/Users/29266/Desktop/主力趋势-6.12-已更新.xlsx";
const outputDir = "output/main_trend_update_20260615";
const projectOutputPath = `${outputDir}/主力趋势-6.15-已更新.xlsx`;
const desktopOutputPath = "C:/Users/29266/Desktop/主力趋势-6.15-已更新.xlsx";

const workbook = await SpreadsheetFile.importXlsx(await FileBlob.load(inputPath));
const sheet = workbook.worksheets.getItemAt(0);
const values = sheet.getUsedRange().values;

const targetSerial = 46188; // 2026-06-15
const header = values[1];
const targetCol = header.findIndex((value) => Number(value) === targetSerial);
if (targetCol < 0) throw new Error("Could not find 2026-06-15 column.");

const targetAddress = sheet.getRangeByIndexes(0, targetCol, 1, 1).address.replace(/\d+$/, "");
if (targetAddress !== "EX") {
  throw new Error(`2026-06-15 is in ${targetAddress}, expected EX.`);
}
